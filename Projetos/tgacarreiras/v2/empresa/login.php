...
<head>
    <meta charset="UTF-8">
    <title>Login Empresa — TGA Carreiras</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Acesse o painel da sua empresa na TGA Carreiras e gerencie suas vagas.">
    ...
    <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-box { width: 100%; max-width: 440px; animation: fadeUp .5s ease-out; }
        ...
        .side-content p   { font-size: 1rem; opacity: .88; max-width: 340px; margin: 0 auto 2.25rem; line-height: 1.6; }
        ...
        .login-header h2 { font-size: 1.75rem; font-weight: 800; color: var(--text); margin-bottom: .35rem; letter-spacing: -.5px; }
        ...
        .empresa-badge {
            ...
            margin-top: .65rem; text-transform: uppercase; letter-spacing: .5px;
        }
        ...
        .form-label { font-weight: 600; font-size: .84rem; color: var(--text-sec); margin-bottom: .45rem; display: block; }
        ...
        .password-toggle {
            ...
            font-size: 1rem; color: var(--text-muted);
            transition: var(--transition); z-index: 1; padding: .2rem;
        }
        ...
        .checkbox-group label { color: var(--text-sec); font-size: .84rem; cursor: pointer; font-weight: 500; }
        ...
        .divider { display: flex; align-items: center; margin: 1.75rem 0; color: var(--text-muted); font-size: .8rem; }
        .divider::before, .divider::after { content: ''; flex: 1; height: 1px; background: var(--border); }
        .divider span { padding: 0 .875rem; }

        .form-footer { text-align: center; }
        .form-footer p { color: var(--text-sec); font-size: .9rem; }
        ...
        .back-link {
            ...
            transition: var(--transition); margin-top: 1.25rem;
        }
        ...
        @media (max-width: 768px) {
            ...
            .side-panel { flex: none; padding: 1.75rem 1.5rem; order: -1; }
            .form-panel { order: 0; }
            .side-icon { width: 56px; height: 56px; font-size: 1.6rem; margin-bottom: 1rem; border-radius: 16px; }
            .side-content h2 { font-size: 1.3rem; margin-bottom: .35rem; }
            .side-content p  { font-size: .85rem; margin-bottom: 1.25rem; }
            .side-stats { grid-template-columns: repeat(4, 1fr); gap: .5rem; max-width: 100%; }
            ...
            .login-icon { width: 60px; height: 60px; font-size: 1.6rem; border-radius: 16px; }
        ...
        @media (max-width: 480px) {
            ...
            .side-icon { width: 46px; height: 46px; font-size: 1.4rem; border-radius: 13px; margin-bottom: .75rem; }
            ...
            .login-icon { width: 52px; height: 52px; font-size: 1.4rem; border-radius: 14px; margin-bottom: 1rem; }
            .login-header h2 { font-size: 1.3rem; }
            .login-header p  { font-size: .82rem; }
            .form-input { padding: .7rem .85rem .7rem 2.5rem; font-size: .86rem; }
            .input-icon { left: .75rem; font-size: .9rem; }
...
<div class="main-container">
    ...
    <div class="form-panel">
        <div class="login-box">
            ...
            <!-- Formulário -->
            <form action="../backend/auth_empresa.php" method="POST" id="loginForm" novalidate>
            ...
            <div class="form-footer">
                <p>Ainda não tem conta? <a href="cadastro.php">Cadastrar empresa</a></p>
            </div>

            <div class="switch-portal">
                <i class="fas fa-user"></i>
                É candidato? <a href="../candidato/login.php">Acesse o portal de candidatos</a>
            </div>
    ...
    <div class="side-panel">
        <div class="side-content">
            ...
            <h2>Gerencie suas vagas<br>com facilidade</h2>
            <p>Publique vagas, analise candidatos e encontre o talento ideal para sua equipe.</p>

            <div class="side-stats">
                <div class="side-stat">
                    <div class="side-stat-icon"><i class="fas fa-clipboard-list"></i></div>
                    <div class="side-stat-value" data-target="500">500+</div>
                    <div class="side-stat-label">Vagas publicadas</div>
                </div>
                <div class="side-stat">
                    <div class="side-stat-icon"><i class="fas fa-users"></i></div>
                    <div class="side-stat-value" data-target="3000">3k+</div>
                    <div class="side-stat-label">Candidatos</div>
                </div>
                <div class="side-stat">
                    <div class="side-stat-icon"><i class="fas fa-handshake"></i></div>
                    <div class="side-stat-value" data-target="850">850+</div>
                    <div class="side-stat-label">Contratações</div>
                </div>
                <div class="side-stat">
                    <div class="side-stat-icon"><i class="fas fa-star"></i></div>
                    <div class="side-stat-value" data-target="95" data-suffix="%">95%</div>
...
document.querySelectorAll(".side-stat-value").forEach(el => observer.observe(el));
</script>
