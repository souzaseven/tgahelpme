  ...
  function criarBotao() {
    ...
    xButton.addEventListener('click', function(e) {
      ...
      msg.style.cssText = `
        ...
        font-size: 14px;
      `;
      msg.innerHTML = 'Botão ocultado. Abra o console (F12) e execute: <br><code style="background:#222;padding:4px 8px;border-radius:4px;">localStorage.removeItem("btnAnuncioOculto")</code> para recuperar.';
    ...
    botao.addEventListener('mouseenter', function() {
      xButton.style.opacity = '1 !important';
    });
    
    botao.addEventListener('mouseleave', function() {
      xButton.style.opacity = '0 !important';
    });
  }
