...
// ============================================================
// TOAST GLOBAL — COMPATIBILIDADE COM TODO O SISTEMA
// (decidir.js, painel.js, supervisao.js, console, etc.)
// ============================================================
window.toastAviso = function (mensagem, tipo = "info") {

    // Mapeia tipos genéricos → visual único do projeto
    const prefixo = {
        success: "✅ ",
        warning: "⚠️ ",
        error:   "❌ ",
    ...
    // Reutiliza o toast profissional já existente
    mostrarToastNotificacao(texto);

    // Log opcional
    logNotif("toastAviso", { tipo, mensagem: texto });
};
