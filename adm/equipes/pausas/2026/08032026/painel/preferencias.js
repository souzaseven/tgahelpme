...
// ------------------------------------------------------------
window.abrirPreferencias = async function () {
    ...
    try {
        const resp = await fetch("../backend/preferencias_obter.php", {
            method: "POST",
            body: new URLSearchParams({ id: operador.id })
        });
            ...
            <div class="prefs-grid">
                ...
                <div class="pref-row">
                    ...
                    <div class="pref-switch" style="flex-direction:column; align-items:stretch;">
                        ...
                        <div style="display:flex; justify-content:space-between; font-size:12px; opacity:.7;">
                            <span>0</span>
                            <span id="labelVolumeFala">${volumeFala}</span>
                            <span>100</span>
                        </div>
                        <button class="btn-testar-pref" onclick="testarFala()">Ouvir</button>
                    </div>
                ...
                <div class="pref-row">
                    ...
                    <div class="pref-switch" style="flex-direction:column; gap:8px;">
                        ...
                        <button class="btn-testar-pref" onclick="enviarTesteWhatsapp()">📲 Enviar teste</button>
                        <small style="opacity:.7">Somente números com DDD</small>
                    </div>
                </div>
