...
// ============================================================
//  FASE 9 — DISPARADOR GLOBAL DE ALERTAS
// ============================================================
window.dispararAlertas = function (evento, extra = {}) {
    ...
    // Toast e beep continuam seguindo apenas os próprios switches
    if (usarToast) {
    ...
    // Controle de ALCANCE vale especificamente para FALA + NOTIFICAÇÃO
    ...
    if (modoAlvo === "nenhum") {
        ...
        // Se o usuário escolheu "apenas meu status"
        // não fala / notifica eventos de outros
        permitirFala  = false;
        permitirNotif = false;
    }
