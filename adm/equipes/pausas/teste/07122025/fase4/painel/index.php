...
<div class="painel-container">
    ...
    <!-- APENAS 1 elemento conteudoExtra -->
...
<script>
// Função GLOBAL para o botão SAIR
...
async function carregarTodasEquipes() {
    ...
    try {
        const resp = await fetch("../backend/todas_equipes.php"); // <===== CAMINHO CORRETO
        ...
        let html = `
            <h2 style='color:#38bdf8;margin-bottom:20px;font-size:22px;'>
                <i class="fa-solid fa-people-group"></i> Todas as Equipes
            </h2>
        ...
        for (const equipe in equipes) {
            html += `
                <div class="card card-equipe" style="
                    background:#0f172a;
                    ...
                    transition:0.2s;
                ">
                    <h3 style="color:#38bdf8;margin-bottom:10px;font-size:18px;">
                        <i class="fa-solid fa-user-tie"></i> ${equipe}
                    </h3>
                    ...
                    <div class="lista-simples">
                        ${equipes[equipe].map(n => `
                            <p style="
                                ...
                                color:#e2e8f0;
                            ">
                                <i class="fa-solid fa-user" style="color:#38bdf8;"></i> ${n}
                            </p>
                        `).join("")}
                    </div>
                </div>
