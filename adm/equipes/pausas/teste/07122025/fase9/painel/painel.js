...
// ---------------------------
    ...
    // ========================================================
    // 4) LISTA DE PAUSA — COM CRONÔMETRO
    //    tempo_pausa_seg deve vir do backend
    // ========================================================
    ...
    function atualizarListaPausa(lista) {
        ...
        // Cada item deve conter tempo_pausa_seg vindo do backend
        box.innerHTML = lista.map(op => {
            const baseSeg = parseInt(op.tempo_pausa_seg ?? 0, 10) || 0;
...
// ========================================================
    ...
    function atualizarFila(lista) {
        ...
        // AQUI usamos posicao_fila e tempo_espera_seg enviados pelo backend
        box.innerHTML = lista.map(op => {
            const baseSeg = parseInt(op.tempo_espera_seg ?? 0, 10) || 0;
