...
async function atualizarPainelEvolux() {
  ...
  if (!lista || !contador) {
    console.warn("[Integração Evolux] Painel ainda não inicializado.");
    return;
  }
...
function iniciarMonitoramentoEvolux() {
  ...
  setInterval(atualizarPainelEvolux, INTERVALO_ATUALIZACAO);
}
