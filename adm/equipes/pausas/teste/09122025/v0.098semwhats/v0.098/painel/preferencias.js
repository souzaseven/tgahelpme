...
<div class="pref-row">
    <div class="pref-info">
        ...
        <span>Controle a altura da voz (0 = mudo • 100 = máximo).</span>
...
if (sliderVolume && labelVolume) {
    ...
    sliderVolume.addEventListener("input", () => {
        ...
        console.log(
            `%c[VOLUME] Slider alterado: ${sliderVolume.value}%`,
...
const pref_volume_fala = parseInt(document.getElementById("prefVolumeFala")?.value ?? 70);
...
// Atualiza objeto do operador logado com o que veio do backend
...
//dados.pref_volume_fala = pref_volume_fala;
...
console.log(
    "%c[PREFERENCIAS] Preferências salvas. Recarregando página para aplicar volume.",
    "color:#22c55e;font-weight:bold;"
);

// Marca no sessionStorage que acabou de salvar
sessionStorage.setItem("cp_pref_salva_agora", "1");

// pequeno delay só para o toast aparecer
setTimeout(() => {
    location.reload(true); // força reload sem reaproveitar JS em memória
}, 600);
