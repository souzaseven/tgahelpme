...
if (ret.success) {
  ...
  // ✅ Atualiza visual e botões imediatamente
  this.atualizarInterfaceStatus(dados.nome, acao);

  // 🔔 Notifica os colegas da equipe
...
// ============================================================
// Notifica visualmente e via sistema apenas a equipe do operador
// ============================================================
...
atualizarInterfaceStatus(nome, acao) {
  ...
  if (novoStatus === "pausa") {
    botoes.innerHTML = `
      <button class="btn-acao" onclick="controle.enviarAcao('voltar_disponivel',{nome:'${nome}',equipe:'${this.buscarEquipePorOperador(nome)}'})">
        ✅ Sair da pausa
      </button>`;
  } 
    ...
    botoes.innerHTML = `
      <button class="btn-acao" onclick="controle.enviarAcao('entrar_fila',{nome:'${nome}',equipe:'${this.buscarEquipePorOperador(nome)}'})">
        🕓 Fila de espera
      </button>
      <button class="btn-acao" onclick="controle.enviarAcao('forcar_pausa',{nome:'${nome}',equipe:'${this.buscarEquipePorOperador(nome)}'})">
        ☕ Entrar em pausa
      </button>`;
  }
}
