...
function obterEquipeDoBloco(bloco) {
  ...
  // Pega o texto completo do título da equipe
  let texto = h3.textContent.trim();

  // Remove tudo que vem depois da palavra "operador"
  // (isso elimina o contador e mantém só o nome da equipe)
  texto = texto.split("operador")[0].trim();

  // Remove emojis e ícones visuais do texto
