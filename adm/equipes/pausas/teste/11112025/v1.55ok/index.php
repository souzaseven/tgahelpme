...
<link rel="stylesheet" href="./css/status_cards.css?v=<?php echo $versao; ?>">
  ...
  <!-- Analytics -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-S8EC5C2WTG(function() {"></script>
...
<script src="./js/status_cards.js?v=<?php echo $versao; ?>"></script>
  ...
  <img alt="Em fase de teste 11-11-2025"
       src="https://hits.sh/tgameajuda.com/teste11-11-2025.html.svg?color=007ced&label=Em fase de teste 11-11-2025&labelColor=FFFFFF&logo=https%3A%2F%2Fraw.githubusercontent.com%2Fsouzaseven%2Ftgahelpme%2FDesafios%2Ficon%2520bot%2520tga.ico"/>
</body>
</html>
