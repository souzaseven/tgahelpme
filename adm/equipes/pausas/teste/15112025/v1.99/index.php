...
<link rel="stylesheet" href="./css/login.css?v=<?php echo $versao; ?>">
  ...
  <!-- Setup dinâmico do sistema (versão em cache controlada por time()) -->
  ...
  <!-- Google Analytics (IDs separados, se necessário) -->
  ...
  <script>
    ...
    // Se quiser usar o segundo ID, descomente:
...
<!--
    ...
    <div id="loginModoEquipe" class="modo-login hidden">
      ...
      <div id="stepOperadores" class="hidden">
        ...
        <p class="texto-secundario">Selecione seu nome na lista abaixo:</p>
