...
<head>
    ...
    <link rel="stylesheet" href="modal_fila.css">
...
<!-- ============================================================
     MODAL — DECISÃO NA FILA DE ESPERA (FASE 7)
============================================================ -->
<div id="modalDecidirFila" class="modal-fila hidden">

    <div class="modal-fila-content">

        <!-- TITULO -->
        <h2 class="modal-fila-titulo">
            <i class="fas fa-list-check"></i>
            Decidir na Fila de Espera
        </h2>

        <!-- TEXTO POSIÇÃO -->
        <p id="textoPosicaoFila" class="texto-posicao-fila">
            Carregando posição...
        </p>

        <!-- AÇÕES DO PRIMEIRO -->
        <div id="blocoAcoesPrimeiro" class="bloco-acoes-primeiro">

            <button id="btnEntrarPausaAgora" class="btn-fila btn-principal">
                <i class="fas fa-hourglass-start"></i>
                Entrar em pausa agora
            </button>

            <button id="btnIrSegundoFila" class="btn-fila btn-secundario">
                <i class="fas fa-arrow-down-1-9"></i>
                Ir para 2º da fila
            </button>

            <button id="btnIrUltimoFila" class="btn-fila btn-secundario">
                <i class="fas fa-arrow-down"></i>
                Ir para último da fila
            </button>

        </div>

        <!-- AÇÕES GERAIS -->
        <div id="blocoAcoesComuns" class="bloco-acoes-comuns">

            <button id="btnSairEspera" class="btn-fila btn-perigo">
                <i class="fas fa-xmark"></i>
                Sair da fila
            </button>

            <button id="btnTrocarOperador" class="btn-fila btn-info">
                <i class="fas fa-right-left"></i>
                Trocar com outro operador
            </button>
        </div>

        <!-- ÁREA DE TROCA -->
        <div id="areaTroca" class="area-troca hidden">

            <h3 class="titulo-troca">
                <i class="fas fa-users-gear"></i>
                Escolher operador para trocar de posição
            </h3>

            <div id="listaOperadoresTroca" class="lista-operadores-troca"></div>
        </div>

        <!-- FECHAR -->
        <div class="modal-footer">
            <button id="btnFecharModalFila" class="btn-fila btn-fechar">
