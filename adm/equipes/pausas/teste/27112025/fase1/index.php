...
<head>
    ...
    <link rel="stylesheet" href="painel/css/todas_equipes.css?v=<?php echo time(); ?>">
...
<div id="acoesOperador" class="acoes-operador">
    ...
    <button id="btnDecidir" class="acao-btn btn-secundario hidden">
        <i class="fas fa-user-cog"></i> Decidir
    </button>

    <button id="btnSairPausa" class="acao-btn btn-perigo hidden">
        <i class="fas fa-times"></i> Sair da Pausa
    </button>

</div>

<!-- MODAL DECIDIR -->
<div id="modalDecidir" class="modal-pref hidden">
    <div class="modal-pref-content">

        <h2 style="margin-bottom:10px;">
            <i class="fas fa-user-cog"></i> Decidir posição na fila
        </h2>

        <div id="opcoesPrimeiro" class="hidden">
            <button class="btn-salvar-pref" onclick="decidirIrParaSegundo()">
                ➤ Ir para segundo da fila
            </button>

            <button class="btn-salvar-pref" onclick="decidirIrParaFinal()">
                ➤ Ir para o final da fila
            </button>

            <button class="btn-salvar-pref" onclick="decidirTrocarPosicao()">
                ➤ Trocar posição com outro operador
            </button>
        </div>

        <div id="opcoesOutros" class="hidden" style="color:#94a3b8;padding:12px;text-align:center;">
            Nenhuma ação disponível para esta posição.
        </div>

        <button class="btn-fechar-pref" onclick="fecharModalDecidir()">Fechar</button>
    </div>
</div>
...
<div id="modalPreferencias" class="modal-pref hidden">
    <div class="modal-pref-content">
        ...
        <button id="btnSalvarPreferencias" class="btn-salvar-pref">Salvar Preferências</button>
...
<!-- FALTAVA ESTA LINHA -->
<script src="painel/js/modal_decidir.js?v=<?php echo time(); ?>"></script>
