<?php
// ============================================================
// analise.php — Análise de gastos por categoria: comparativo ano
// a ano (com tendência dos últimos 12 meses) e análise inteligente
// (gasto do mês atual contra a média dos 3 meses anteriores, por
// categoria, pra destacar onde o usuário fugiu do padrão).
//
// GET ?tipo=comparativo&mes=M&ano=AAAA
// GET ?tipo=inteligente&mes=M&ano=AAAA  (padrão)
// ============================================================
...
if ($tipo === 'comparativo') {
    ...
    for ($i = 11; $i >= 0; $i--) {
        ...
        $tendencia[] = [
            'label' => $mesesAbrev[$mRef - 1] . '/' . $dt->format('y'),
            'mes'   => $mRef, 'ano' => $yRef,
