<?php
// ============================================================
// busca.php — Busca global (Ctrl+K), varre transações, contas,
// cartões, categorias e metas ao mesmo tempo e devolve um único
// feed de resultados já com ícone/link prontos pro card de busca.
//
// GET ?q=texto
// ============================================================
