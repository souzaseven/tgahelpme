<?php
// ============================================================
// dados.php — "Zona de perigo" da tela de Configurações: mostra
// quantos registros existem por módulo e permite apagar em massa
// (por módulo ou tudo de uma vez). Operação destrutiva e sem
// desfazer — cada exclusão também recalcula o saldo das contas
// pra não deixar valor "fantasma" de transações já pagas.
// ============================================================
