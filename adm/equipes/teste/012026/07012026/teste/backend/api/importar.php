<?php
// ============================================================
// importar.php — Importação de extrato bancário (tela Importar
// Extrato). Fluxo em duas etapas, de propósito: primeiro só faz o
// parse do arquivo (OFX ou CSV) e devolve a lista pro usuário
// conferir/editar na tela; só quando ele confirma é que a ação
// 'salvar' de fato grava as transações no banco. Isso evita importar
// lixo direto sem o usuário ver o que veio no arquivo.
//
// POST ?acao=parsear (multipart, campo "arquivo") — lê o arquivo e devolve a prévia
// POST ?acao=salvar  (JSON, { transacoes: [...] }) — grava a lista confirmada
// ============================================================
