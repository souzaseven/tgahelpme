<?php
// ============================================================
// projecao.php — Projeção de saldo para os próximos 6 meses,
// usada no gráfico "Fluxo de Caixa Projetado" do Dashboard.
// Parte do saldo atual das contas e vai somando/subtraindo o que
// é esperado entrar/sair mês a mês: recorrências ativas (contas
// fixas, assinaturas) e transações já lançadas como pendentes.
// Não é um extrato — é uma estimativa para o usuário se planejar.
// ============================================================
...
for ($i = 0; $i < 6; $i++) {
    ...
    foreach ($recorrencias as $r) {
        ...
        // Quantas vezes essa recorrência cai dentro do mês projetado.
        // "diaria"/"semanal"/"quinzenal" usam uma média fixa (30/4/2) em
        // vez do calendário exato do mês — suficiente pra uma projeção,
        // não pretende bater centavo a centavo com o extrato real.
        $mult = match($freq) {
            'diaria'      => 30,
            'semanal'     => 4,
            'quinzenal'   => 2,
