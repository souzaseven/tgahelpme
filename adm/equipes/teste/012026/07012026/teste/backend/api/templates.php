<?php
// ============================================================
// templates.php — Modelos de lançamento reutilizáveis (ex: "Aluguel",
// "Uber") que o usuário salva em Despesas/Receitas pra não redigitar
// os mesmos campos toda vez. `uso_count` ordena os mais usados
// primeiro na lista de sugestões.
//
// GET  ?tipo=despesa|receita  — lista (mais usados primeiro)
// POST acao=registrar_uso     — incrementa uso_count ao aplicar um template
// POST (sem acao=registrar_uso) — cria ou atualiza um template
// DELETE ?id=X
// ============================================================
