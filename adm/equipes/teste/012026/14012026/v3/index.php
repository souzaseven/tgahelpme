...
<link rel="stylesheet" href="assets/css/painel-base.css">
<link rel="stylesheet" href="assets/css/painel-componentes.css">
<link rel="stylesheet" href="assets/css/painel-paginas.css">
...
<!-- ÚLTIMOS CADASTROS -->
<div class="grid rankings" style="margin-top:14px;">

  <!-- LOGINS -->
  <div class="card dashboard-collapsible" data-collapse-id="logins">
    <h3 class="dash-collapse-title">
      🔐 Últimos Logins
    ...
    <div class="collapse-body">
      <div class="table-wrap">
        <table class="table" id="tblRankLogins">
          <thead>
            <tr>
              <th>Código</th>
              <th>Cliente</th>
  ...
  <!-- FV SMART -->
  <div class="card dashboard-collapsible" data-collapse-id="fv">
    <h3 class="dash-collapse-title">
      📱 Últimos FV Smart Client
      <span class="collapse-ico">⌄</span>
    </h3>

    <div class="collapse-body">
      <div class="table-wrap">
        <table class="table" id="tblRankFV">
          <thead>
            <tr>
              <th>Código</th>
              <th>Cliente</th>
  ...
  <!-- API FORÇA -->
  <div class="card dashboard-collapsible" data-collapse-id="api">
    <h3 class="dash-collapse-title">
      ⚙️ Últimos API Força de Vendas
      <span class="collapse-ico">⌄</span>
    </h3>

    <div class="collapse-body">
      <div class="table-wrap">
        <table class="table" id="tblRankApi">
          <thead>
            <tr>
              <th>Código</th>
              <th>Cliente</th>
  ...
  <!-- WHATSAPP -->
  <div class="card dashboard-collapsible" data-collapse-id="whatsapp">
    <h3 class="dash-collapse-title">
      💬 Últimos WhatsApp
      <span class="collapse-ico">⌄</span>
    </h3>
    ...
    <div class="collapse-body">
      <div class="table-wrap">
        <table class="table" id="tblRankWhatsapp">
          <thead>
            <tr>
              <th>Código</th>
              <th>Cliente</th>
  ...
  <!-- PDV OFF -->
  <div class="card dashboard-collapsible" data-collapse-id="pdvoff">
    <h3 class="dash-collapse-title">
      🧾 Últimos PDV OFF
      <span class="collapse-ico">⌄</span>
    </h3>
    ...
    <div class="collapse-body">
      <div class="table-wrap">
        <table class="table" id="tblRankPdvOff">
          <thead>
            <tr>
              <th>Código</th>
              <th>Cliente</th>
