...
<th>Porta</th>
  ...
  <div class="server-actions">
    <a
      href="../assets/files/openvpn-7.rar"
      class="btn primary"
      download
    >
      🔐 Baixar VPN
    ...
    <!-- 4️⃣ Gateway -->
          ...
          <div class="card server-section">
            ...
            <ul class="server-list grid">
              <li><strong>SRVTGAFV01</strong><p style: color= 'yellow'>Comercial e Desenvolvimento</p></li><li><strong>SRVTGAFV02</strong></li><li><strong>SRVTGAFV03</strong></li><li><strong>SRVTGAFV04</strong></li>
...
<div class="view hidden" id="view-relatorios">
  <div class="card">
    <h2>Relatórios</h2>
    <button class="btn primary" id="btnRelatorioLogins">📊 Relatório de Logins</button>
  </div>
</div>

<!-- MODAL DE RELATÓRIOS -->
<div id="modalLogins" class="modal-relat">
  <h3>Filtros de Logins</h3>
...
<select name="exe" id="loginExe">
  <option value="">Todos</option>
  <option value="1">Somente com EXE</option>
  <option value="0">Somente sem EXE</option>
</select>

  <label>Data de Criação (de até):</label>
  ...
  <div class="campo-grupo">
    ...
    <select name="ordenar_por">
      ...
      <option value="codigo_cliente">Código Cliente</option>
      <option value="nome_cliente">Nome Cliente</option>
      <option value="status">Status</option>
      <option value="versao_padrao">Versão</option>
    </select>
  </div>
