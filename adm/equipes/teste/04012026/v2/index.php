...
// CSRF já é gerado no conexao.php
...
<button class="menu-item" data-tab="whatsapp">
  <span class="mi-ico">💬</span>
  <span class="mi-label">Clientes WhatsApp</span>
</button>
        ...
        <section class="content">
            ...
            <div class="grid kpis">
                ...
                <div class="kpi-head">
                    <span class="kpi-ico">🧷</span>
                    <span class="kpi-title">FV MOBILE ON</span>
                </div>
                ...
                <div class="kpi-head">
                    ...
                    <span class="kpi-title">APIs MOBILE OFF</span>
                </div>
                ...
                <div class="kpi-head">
                    <span class="kpi-ico">📱</span>
                    <span class="kpi-title">API WHATSAPP</span>
                </div>
    ...
    <tr>
        ...
        <th data-field="codigo_cliente">Código</th>
        <th data-field="nome_cliente">Cliente</th>
        <th data-field="caminho_acesso">Caminho</th>
        <th data-field="versao_padrao">Versão</th>
    ...
    <div class="card">
        ...
        <span class="muted">Em desenvolvimento</span>
        </div>
        <div style="padding:20px;" class="muted">
        Módulo destinado ao cadastro e monitoramento de servidores,
        APIs internas, portas, serviços e health-checks.
        </div>
    </div>
    </div>
...
<select id="fConTipo">
  ...
  <option value="API_MOBILE_OFF">API_MOBILE_OFF</option>
</select>
    ...
    <tr>
        <th data-field="id">ID</th>
        <th data-field="cod_cliente">Código</th>
        <th data-field="cliente">Cliente</th>
        <th data-field="acesso_server">Servidor</th>
        <th data-field="porta">Porta</th>
        <th data-field="tipo_acesso">Tipo</th>
        <th data-field="status">Status</th>
        <th>Ações</th>
    </tr>
    </thead>
