...
function brlC(float $v): string { return 'R$ '.number_format($v,2,',','.'); }
...
.modal-box { background:var(--bg-800); border:1px solid var(--border); border-radius:var(--radius-lg); width:100%; max-width:560px; max-height:92vh; display:flex; flex-direction:column; box-shadow:var(--shadow-lg); animation:mIn .18s ease; }
...
<div class="comparacao-grid" style="grid-template-columns:repeat(auto-fill,minmax(200px,1fr))">
    ...
    <div class="kpi-card <?= $cor ?>">
        ...
        <div class="kpi-value"><?= brlC($total) ?></div>
    ...
    <div class="kpi-card indigo" style="border:2px solid var(--indigo)">
        ...
        <div class="kpi-value"><?= brlC($saldoGeral) ?></div>
