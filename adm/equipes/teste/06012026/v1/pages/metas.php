...
function brlM(float $v): string { return 'R$ '.number_format($v,2,',','.'); }
...
.modal-box { background:var(--bg-800); border:1px solid var(--border); border-radius:var(--radius-lg); width:100%; max-width:580px; max-height:92vh; display:flex; flex-direction:column; box-shadow:var(--shadow-lg); animation:mIn .18s ease; }
...
<div class="kpi-grid" style="grid-template-columns:repeat(4,1fr);margin-bottom:1.25rem">
    ...
    <div class="kpi-card violet">
        ...
        <div class="kpi-value"><?= brlM($totAlvo) ?></div>
    ...
    <div class="kpi-card indigo">
        ...
        <div class="kpi-value"><?= brlM($totAtual) ?></div>
...
<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:1rem">
    ...
    <div class="meta-card <?= htmlspecialchars($m['status']) ?>"
        ...
        <div class="meta-valores">
            <div>
                <div class="meta-atual" style="color:<?= $cor ?>"><?= brlM((float)$m['valor_atual']) ?></div>
                <div class="meta-alvo">de <?= brlM((float)$m['valor_alvo']) ?></div>
            </div>
        ...
        <div class="text-xs text-muted">
            ...
            Aporte sugerido: <strong><?= brlM((float)$m['aporte_mensal']) ?>/mês</strong>
