...
<body>
  ...
  <div class="login-wrapper">
    <div class="login-card">
      ...
      <!-- Nuvens decorativas flutuando dentro do card -->
      <div class="login-clouds" aria-hidden="true">
  ...
  <!-- ── Anúncio lateral esquerda (160×600, oculto < 1200px) ── -->
  <div class="ad-lateral ad-lateral-esq" aria-hidden="true">
  ...
  <!-- ── Anúncio lateral direita (160×600, oculto < 1200px) ── -->
  <div class="ad-lateral ad-lateral-dir" aria-hidden="true">
    <ins class="adsbygoogle"
      style="display:inline-block;width:160px;height:600px"
      data-ad-client="ca-pub-8542251167876044"
      data-ad-slot="auto"
  ...
  <!-- ── Anúncio rodapé (728×90, oculto < 600px) ── -->
  <div class="ad-rodape" aria-hidden="true">
    <ins class="adsbygoogle"
