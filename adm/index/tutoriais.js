...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function filterContent() {
        ...
        if (!term) {
            ...
            document.querySelectorAll('.Downloads-item').forEach(i => i.style.display = '');
        ...
        document.querySelectorAll('section').forEach(section => {
            ...
            const items        = section.querySelectorAll('.Downloads-item');
            let visibleItems   = 0;
            if (items.length > 0) {
                items.forEach(item => {
...
// Fecha o menu antes de rolar: com o menu aberto, ele desloca/encobre o alvo,
// fazendo a primeira rolagem parecer "errada" até o menu ser fechado depois.
