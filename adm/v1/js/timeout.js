...
/*
        ...
        */
// ⏰ TEMPOS ATUAIS CONFIGURADOS:
this.timeoutDuration = 1 * 60 * 1000;     // 1 minuto = Tempo total de inatividade
this.warningDuration = 30 * 1000;         // 30 segundos = Aviso antes do bloqueio  
this.logoutDuration = 30 * 1000;          // 30 segundos = Tempo após bloqueio para logout automático
        this.timer = null;
