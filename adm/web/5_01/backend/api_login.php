...
try {
  ...
  if ($action === 'update') {
    ...
    $stmtAntes = $pdo->prepare("SELECT codigo_cliente,nome_cliente,cnpj,caminho_acesso,versao_padrao,regiao,status,possui_exe,exe_nome FROM clientes_web_login WHERE id = ? LIMIT 1");
