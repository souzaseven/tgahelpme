      ...
      <section class="content">
        ...
        <div class="view" id="view-dashboard">
          ...
          <div class="grid kpis">
            ...
            <!-- CARD USUÁRIOS WEB -->
            <div class="card card-kpi users-web kpi--purple">
            ...
            <div class="card kpi kpi--whatsapp">
          ...
          <div class="grid" style="margin-top:14px;">
            ...
            <div class="card">
              <h3 style="margin:0 0 10px;">Últimos Usuários Cadastrados</h3>
              <div class="table-wrap">
            ...
            <!-- Últimos Mobile -->
            <div class="card">
              <h3 style="margin:0 0 10px;">Últimos Mobile Cadastrados</h3>
              <div class="table-wrap">
            ...
            <!-- Últimos WhatsApp -->
            <div class="card">
              <h3 style="margin:0 0 10px;">Últimos WhatsApp Cadastrados</h3>
              <div class="table-wrap">
            ...
            <!-- Últimos PDV OFF -->
            <div class="card">
              <h3 style="margin:0 0 10px;">Últimos PDV OFF Cadastrados</h3>
              <div class="table-wrap">
            ...
            <!-- Últimos BI -->
            <div class="card">
              <h3 style="margin:0 0 10px;">Últimos BI Cadastrados</h3>
              <div class="table-wrap">
          ...
          <h3 style="margin:22px 0 10px;font-size:1rem;opacity:.8">Últimas Atualizações</h3>
          <div class="grid" style="margin-top:0;">

            <div class="card">
              <h3 style="margin:0 0 10px;font-size:.88rem">🏢 Empresas</h3>
              <div id="cardUpdLogins"><span style="opacity:.4;font-size:.85rem">Nenhuma atualização</span></div>
            </div>

            <div class="card">
              <h3 style="margin:0 0 10px;font-size:.88rem">👥 Usuários Web</h3>
              <div id="cardUpdUsuarios"><span style="opacity:.4;font-size:.85rem">Nenhuma atualização</span></div>
            </div>

            <div class="card">
              <h3 style="margin:0 0 10px;font-size:.88rem">📱 Mobile</h3>
              <div id="cardUpdMobile"><span style="opacity:.4;font-size:.85rem">Nenhuma atualização</span></div>
            </div>

            <div class="card">
              <h3 style="margin:0 0 10px;font-size:.88rem">💬 WhatsApp</h3>
              <div id="cardUpdWhatsapp"><span style="opacity:.4;font-size:.85rem">Nenhuma atualização</span></div>
            </div>

            <div class="card">
              <h3 style="margin:0 0 10px;font-size:.88rem">🖥️ PDV OFF</h3>
              <div id="cardUpdPdvOff"><span style="opacity:.4;font-size:.85rem">Nenhuma atualização</span></div>
            </div>

            <div class="card">
              <h3 style="margin:0 0 10px;font-size:.88rem">📊 BI</h3>
              <div id="cardUpdBi"><span style="opacity:.4;font-size:.85rem">Nenhuma atualização</span></div>
            </div>
