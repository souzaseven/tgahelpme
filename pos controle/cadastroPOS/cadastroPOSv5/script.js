...
document.getElementById('editForm').addEventListener('submit', async function (e) {
    e.preventDefault();
    // Debug: Verificar se o ID está sendo capturado corretamente
    const editId = document.getElementById('editId').value;
    console.log("ID do ticket a ser editado:", editId);

    const formData = new FormData();
    formData.append('id', document.getElementById('editId').value);
    formData.append('ticket', document.getElementById('editTicket').value);
    formData.append('empresa', document.getElementById('editEmpresa').value);
    formData.append('cnpj', document.getElementById('editCnpj').value);
    formData.append('cod_cliente_tga', document.getElementById('editCodCliente').value);
    formData.append('quant_smart', document.getElementById('editQuant').value);
    formData.append('adquirente', document.getElementById('editAdquirente').value);
    formData.append('modelo', document.getElementById('editModelo').value);
    formData.append('solicitacao', document.getElementById('editSolicitacao').value);
    formData.append('anotacao', document.getElementById('editAnotacao').value);
    formData.append('monitor', document.getElementById('editMonitor').value);
    formData.append('status', document.getElementById('editStatus').value);

// Debug: Verificar conteúdo do FormData antes do envio
    console.log("Conteúdo do FormData:");
    for (let [key, value] of formData.entries()) {
        console.log(key, value);
    }

    const imagem = document.getElementById('editImagemAnexo')?.files[0];
    if (imagem) {
        formData.append('editImagemAnexo', imagem);
    }
// Debug: Verificar conteúdo do FormData antes do envio
    console.log("Conteúdo do FormData:");
    for (let [key, value] of formData.entries()) {
